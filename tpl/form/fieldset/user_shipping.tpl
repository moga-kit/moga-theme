...
<div id="shippingAddressForm" [{if $delivadr}]style="display: none;"[{/if}]>
    ...
    <div class="mb-3 form-floating[{if $aErrors.oxaddress__oxstreet}] oxInValid[{/if}]">
    ...
    <div class="mb-3 form-floating[{if $aErrors.oxaddress__oxzip || $aErrors.oxaddress__oxcity}] oxInValid[{/if}]">
