...
<div class="row gx-2">
    <div class="col-md-6 mb-3[{if $aErrors.oxuser__oxfname}] text-danger[{/if}] form-floating">
    ...
    <div class="col-md-6 mb-3[{if $aErrors.oxuser__oxlname}] text-danger[{/if}] form-floating">
...
<div class="mb-3 form-floating[{if $aErrors.oxuser__oxstreet}] text-danger[{/if}]">
    <div class="row gx-2">
        <div class="col-8">
        ...
        <div class="col-4">
            ...
            <label class="[{if $oView->isFieldRequired(oxuser__oxstreetnr)}] req[{/if}]">[{oxmultilang ident="STREETNO"}]</label>
            [{include file="message/inputvalidation.tpl" aErrors=$aErrors.oxuser__oxstreetnr}]
        </div>
    </div>
</div>

<div class="mb-3 form-floating[{if $aErrors.oxuser__oxzip}] text-danger[{/if}]">
    <div class="row gx-2">
        <div class="col-5">
...
[{if $oViewConf->showBirthdayFields()}]
    <div class="mb-3 form-floating oxDate[{if $aErrors.oxuser__oxbirthdate}] text-danger[{/if}]">
