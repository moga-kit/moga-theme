...
<div class="card">
    <form class="js-oxValidate" id="optionLogin" name="login" action="[{$oViewConf->getSslSelfLink()}]" method="post"  novalidate="novalidate">
        ...
        <div class="card-footer text-right">
            <button type="submit" class="btn btn-primary submitButton">[{oxmultilang ident="LOGIN"}] <i class="moga-right"></i></button>
        </div>
    </form>
</div>
