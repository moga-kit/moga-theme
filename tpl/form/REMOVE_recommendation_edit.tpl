<form action="[{$oViewConf->getSelfActionLink()}]" name="saverecommlist" method="post" class="max-600">
    ...
    <div class="mb-3">
        <label class="form-label col-lg-3 req">[{oxmultilang ident="TITLE"}]</label>
        <div class="col-lg-9">
            <input type="text" name="recomm_title" class="form-control" maxlength="73" value="[{$actvrecommlist->oxrecommlists__oxtitle->value}]">
        </div>
    </div>
    <div class="mb-3">
        <label class="form-label col-lg-3">[{oxmultilang ident="AUTHOR"}]</label>
        <div class="col-lg-9">
    ...
    <div class="mb-3">
        <label class="form-label col-lg-3">[{oxmultilang ident="INTRODUCTION"}]</label>
        <div class="col-lg-9">
    ...
    <div class="mb-3">
        <div class="offset-lg-3 col-lg-9">
            ...
            [{if $_actvrecommlist}]
                <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account_recommlist"}]" class="btn btn-outline-primary" title="[{oxmultilang ident="DD_RECOMMENDATION_EDIT_BACK_TO_LIST"}]">
                    [{oxmultilang ident="DD_RECOMMENDATION_EDIT_BACK_TO_LIST"}]
                </a>
            [{/if}]
        </div>
    </div>
