        ...
        [{block name="user_checkout_registration_form"}]
            ...
            [{block name="user_checkout_registration_next_step_top"}]
                <div class="card bg-light cart-buttons">
                    <div class="card-body">
                        <a href="[{oxgetseourl ident=$oViewConf->getBasketLink()}]" class="btn btn-outline-primary prevStep submitButton largeButton" id="userBackStepTop">[{oxmultilang ident="PREVIOUS_STEP"}]</a>
                    </div>
                </div>
            [{/block}]
