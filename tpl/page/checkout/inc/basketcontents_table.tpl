                        ...
                        [{if $oView->isWrapping()}]
                            <td align="center">
                                [{if !$basketitem->getWrappingId()}]
                                    [{if $editable}]
                                        <a href="#" class="btn btn-outline-primary btn-sm" title="[{oxmultilang ident="ADD"}]" data-toggle="modal" data-target="#giftoptions">[{oxmultilang ident="ADD"}]</a>
                                    [{else}]
                                ...
                                [{else}]
                                    ...
                                    [{if $editable}]
                                        <a class="btn btn-outline-primary btn-sm" href="#" title="[{oxmultilang ident="ADD"}]" data-toggle="modal" data-target="#giftoptions"><i class="moga-pencil"></i> [{$oWrap->oxwrapping__oxname->value}]</a>
                                    [{else}]
            ...
            <tfoot id="basketFn" class="basketFunctions">
                <tr>
                    ...
                    <td colspan="[{if $oView->isWrapping()}]6[{else}]5[{/if}]">
                        ...
                        <button name="updateBtn" class="btn btn-sm btn-outline-primary" id="basketUpdate" type="submit">[{oxmultilang ident="UPDATE"}]</button>
                    </td>
                </tr>
            </tfoot>
        [{/if}]
