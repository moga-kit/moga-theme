                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-primary float-right submitButton Button edit-button" title="[{oxmultilang ident="EDIT"}]">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-outline-primary float-right submitButton largeButton edit-button" title="[{oxmultilang ident="EDIT"}]">
                                                <i class="moga-pencil"></i>
                                            </button>
                                        </h3>
                                    </div>
                            ...
                            <div class="card bg-light cart-buttons">
                                <div class="card-body">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-primary float-right submitButton nextStep largeButton">
                                        <i class="moga-check"></i> [{oxmultilang ident="SUBMIT_ORDER"}]
                                    </button>
                                    [{/block}]
