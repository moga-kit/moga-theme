            ...
            [{if $imageStyle == "grid"}]
                <div class="row g-1">
                    ...
                    [{if $imageCount > 0}]
                        ...
                        [{/foreach}]
                    [{else}]
                        <img class="details-thumb-img" loading="lazy"  src="[{$oView->getActPicture()}]" alt="[{$oPictureProduct->oxarticles__oxtitle->value|strip_tags}] [{$oPictureProduct->oxarticles__oxvarselect->value|strip_tags}]" itemprop="image">
                    [{/if}]
