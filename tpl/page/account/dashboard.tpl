        ...
        <div class="col mb-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-primary stretched-link" href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account_noticelist"}]">
                        [{oxmultilang ident="MORE"}]
                    </a>
                </div>
            </div>
            ...
            <div class="col mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-primary stretched-link" href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account_wishlist"}]">
                            [{oxmultilang ident="MORE"}]
                        </a>
                    </div>
                </div>
            ...
            <div class="col mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-primary stretched-link" href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=compare"}]">
                            [{oxmultilang ident="MORE"}]
                        </a>
                    </div>
                </div>
            ...
            <div class="col mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <a class="btn btn-outline-primary stretched-link" href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account_reviewlist"}]">
                            [{oxmultilang ident="MORE"}]
                        </a>
                    </div>
                </div>
