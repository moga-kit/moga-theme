                                            ...
                                            [{/if}]
                                                ...
                                                [{if $oViewConf->isModuleActive('cnc/imagebutler')}]
                                                    <picture>
                                                        ...
                                                        <source srcset="[{$oViewConf->getDynamicImage($sBannerPictureUrl, 350, 300, 'jpg')}]" media="(max-width: 767px)">
                                                        ...
                                                        <source srcset="[{$oViewConf->getDynamicImage($sBannerPictureUrl, 1000, 600, 'jpg')}]">
                                                        [{else}]
                                                        <source type="image/webp" srcset="[{$oViewConf->getDynamicImage($sBannerPictureUrl, 700, 450, 'webp')}]">
                                                        <source srcset="[{$oViewConf->getDynamicImage($sBannerPictureUrl, 700, 450, 'jpg')}]">
                                                        [{/if}]
